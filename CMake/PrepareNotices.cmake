...
endforeach()
include("${CMAKE_CURRENT_LIST_DIR}/VerifyNoticeSource.cmake")
...
foreach(number RANGE ${supplemental_last})
  ...
  toolchain_verify_notice_source("${TOOLCHAIN_${component}_SOURCE}/${source_path}" "${entry}"
    "${TOOLCHAIN_REPOSITORY_ROOT}/Licenses/${path}")
